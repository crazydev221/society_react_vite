...
const Header = () => {
  ...
  return (
    ...
    (<header className="flex py-4 shadow-md">
      <div className='flex w-full xl:w-[1250px] lg:w-[1000px] md:w-[750px] sm:w-[640px] mx-auto items-center justify-between'>
        <a href='/'>
        ...
        <div className='hidden gap-8 lg:flex'>
          {
            ...
            ( <>
              ...
              <>
                ...
                <a href='/logout' className="flex items-center px-4 py-2 hover:bg-gray-100">
                  Logout
                </a>
              </>
            )
